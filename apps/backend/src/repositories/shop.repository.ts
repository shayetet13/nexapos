...
export const shopRepository = {
  ...
  async createShop(name: string, opts?: { postalCode?: string; province?: string; district?: string }) {
    ...
    return db.insert(shops).values({ name, shop_code, province, district, postal_code })
