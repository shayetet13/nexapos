import { eq, and, sql, lte, gte, desc, inArray, isNull } from 'drizzle-orm';
...
export const stockRepository = {
  ...
  getAllStockInShop(shopId: string, opts?: { limit?: number; offset?: number }) {
    ...
    return db
      ...
      .where(and(eq(products.shop_id, shopId), isNull(products.deleted_at), eq(branches.is_active, true)))
