            ...
            <div className="page-admin__links">
              ...
              {(() => {
                ...
                if (branches.length === 1) {
                  const b    = branches[0];
                  const nm   = shops.find((shop) => shop.id === shopId)?.name ?? '';
                  const mode = (shops.find((shop) => shop.id === shopId)?.shop_mode as ShopMode | undefined) ?? 'retail';
                  return (
                    <Link
                      href={workAreaHref({
                        shopId,
                    ...
                    >
                      {mode === 'full_service_restaurant' ? '🍽 ภัตตาคาร' : '🏪 POS'}
                    </Link>
                  );
                }
                return (
