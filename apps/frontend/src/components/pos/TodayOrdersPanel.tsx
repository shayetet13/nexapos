...
export function TodayOrdersPanel({
  ...
  return (
    <>
      <div className="pos-today-overlay" onClick={onClose} />
      <div className="pos-today-panel">
        <div className="pos-today-panel__head">
          <span className="pos-today-panel__title">ออเดอร์วันนี้</span>
          <span className="pos-today-panel__count">{totalCount} ออเดอร์</span>
          <button className="pos-today-panel__close" onClick={onClose} aria-label="ปิด">✕</button>
        </div>
