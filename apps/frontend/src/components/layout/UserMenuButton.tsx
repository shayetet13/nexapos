...
import {
  ...
  getGuestThemeFromStorage,
  getPersistedThemeForUserId,
...
function hasExplicitStoredTheme(): boolean {
  const uid = getActiveUserIdFromStorage();
  if (uid) return getPersistedThemeForUserId(uid) != null;
  return getGuestThemeFromStorage() != null;
}
